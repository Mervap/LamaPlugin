...
public class LamaAssignmentOperatorImpl extends LamaOperatorImpl implements LamaAssignmentOperator {

  public LamaAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
