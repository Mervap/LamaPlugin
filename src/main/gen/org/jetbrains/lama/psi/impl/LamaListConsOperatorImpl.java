...
public class LamaListConsOperatorImpl extends LamaOperatorImpl implements LamaListConsOperator {

  public LamaListConsOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LamaVisitor visitor) {
    visitor.visitListConsOperator(this);
  }
