...
public class LamaMulDivModOperatorImpl extends LamaOperatorImpl implements LamaMulDivModOperator {

  public LamaMulDivModOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LamaVisitor visitor) {
    visitor.visitMulDivModOperator(this);
  }
